...
def motor_register_interaction(numberplate):
    ...
    brand_model_variant = browser.find_element(By.XPATH,
                                               '/html/body/div[2]/div/div[1]/div[2]/div[3]/div/div[2]/div[1]/div[2]/div/div[1]/div[1]/div/div[2]/span[2]').text
    brand = brand_model_variant.split(',')[0]
    model = brand_model_variant.split(',')[1]

    year = browser.find_element(By.XPATH,
                                '/html/body/div[2]/div/div[1]/div[2]/div[3]/div/div[2]/div[1]/div[4]/div/div[1]/div[4]/div[2]/span').text
    first_reg_year = browser.find_element(By.XPATH,
                                          '/html/body/div[2]/div/div[1]/div[2]/div[3]/div/div[2]/div[1]/div[2]/div/div[1]/div[2]/div/div[2]/span[2]').text
    gear_type = browser.find_element(By.XPATH,
                                     '/html/body/div[2]/div/div[1]/div[2]/div[3]/div/div[2]/div[1]/div[12]/div/div[1]/div[1]/div[2]/span').text
